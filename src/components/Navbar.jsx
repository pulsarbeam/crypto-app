...
const Navbar = () => {
  ...
  return (
    <div className="rounded-div flex items-center justify-between h-20 font-bold">
      <Link to="/">
        <h1 className="text-2xl">CryptoGoat</h1>
      </Link>
      ...
      {user?.email ? (
        <div>
          ...
          <button className="font-normal" onClick={handleSignout}>
            Sign Out
          </button>
        </div>
      ) : (
      ...
      <div
        className={
          nav
            ? 'md:hiddden fixed left-0 top-20 flex flex-col items-center justify-between w-full h-[90%] bg-primary ease-in duration-300 z-10'
